...
public class ItemDetailsDto {
    ...
    public ItemDetailsDto(Long id, String title, String description, Long sellerId, double startingPrice, String category, Date registrationClosingDate, Date auctionStartDate) {
        this.id = id;
        this.title = title;
